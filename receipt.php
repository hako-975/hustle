...
<body>
    <!-- Start Top Nav -->
    <nav class="no-print navbar navbar-expand-lg bg-dark navbar-light d-none d-lg-block" id="templatemo_nav_top">
    ...
    <!-- Header -->
    <nav class="no-print navbar navbar-expand-lg navbar-light shadow">
    ...
    <!-- Start Footer -->
    <footer class="bg-dark no-print" id="tempaltemo_footer">
        <div class="container">
            <div class="row">
